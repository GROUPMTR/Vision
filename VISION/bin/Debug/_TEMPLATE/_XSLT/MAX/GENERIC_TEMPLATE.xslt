							...
							<tr valign="top">
								...
								<td width="20%" align="center" valign="middle">
									...
									<img  align="middle" width="50%"  alt="E-Fatura Logo"
										src="data:image/png;base64," ></img>
									<h1 align="center">
										<span style="font-weight:bold; ">
											<xsl:text></xsl:text>
										</span>
					...
					<tbody>
						<tr align="left">
							...
							<!--<xsl:if test="//n1:Invoice/cbc:Note">
								...
								<br/>
								<br/>
								<xsl:text>Maxus Medya Hizmetleri Tic.Ltd.Şti.</xsl:text>
								<br/>
								<xsl:text>AKBANK	MASLAK TİCARİ	TL	TR53 0004 6007 8688 8000 0589 23</xsl:text>
								<br/>
								<xsl:text>AKBANK	MASLAK TİCARİ	USD	TR47 0004 6007 8600 1000 0589 25</xsl:text>
								<br/>
								<xsl:text>AKBANK	MASLAK TİCARİ	EURO	TR51 0004 6007 8603 6000 0589 24</xsl:text>
								<br/>
								<xsl:text>AKBANK	MASLAK TİCARİ	GBP	TR64 0004 6007 8600 3000 0589 39</xsl:text>
								<br/>
								<xsl:text>HSBC	KÜRESEL BANKACILIK	TL	TR68 0012 3007 4410 2687 4282 00</xsl:text>
								<br/>
							</td>
						</tr>
					</tbody>
